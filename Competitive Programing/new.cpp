...
// function to calculate the Longest Prefix Suffix array 
void getLps(vt<int> &lps){
...
// function that check weather the pattern exists in string or not  
bool KMP(vt<int> &lps){
    int i=0;
    int j=0;
    int s_len = str.sz;
